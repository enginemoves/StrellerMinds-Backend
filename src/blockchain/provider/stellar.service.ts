...
//   private server: any; // Using 'any' to avoid type conflicts
...
//     // Create server instance without explicit typing
...
//    * Note: This requires @stellar/stellar-sdk with Soroban support
//    */
//   async deploySorobanContract(
//     sourceKeypair: any,
//     wasmId: string,
//   ): Promise<any> {
//     try {
//       // Check if Soroban operations are available
//       if (!StellarSdk.Operation.createSorobanContract) {
//         throw new Error(
//           'Soroban operations not available in this version of stellar-sdk',
//         );
//       }
...
//           (StellarSdk.Operation as any).createSorobanContract({
//             wasmId: wasmId,
//           }),
//         )
//         .setTimeout(30)
...
//     try {
//       // Check if Soroban operations are available
//       if (!(StellarSdk.Operation as any).invokeSorobanContract) {
//         throw new Error(
//           'Soroban operations not available in this version of stellar-sdk',
//         );
//       }
...
//         .addOperation(
//           // Use type assertion to bypass TypeScript errors
//           (StellarSdk.Operation as any).invokeSorobanContract({
...
//     } catch (error) {
//       this.logger.error(
//         `Error getting transaction ${transactionHash}: ${error.message}`,
//       );
//       throw error;
//     }
//   }
...
//     } catch (error) {
//       this.logger.error(
//         `Error getting operations for transaction ${transactionHash}: ${error.message}`,
//       );
//       throw error;
//     }
//   }
